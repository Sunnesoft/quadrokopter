...
static const char * c14_debug_family_names[13] = { "P", "M", "nargin", "nargout",
  ...
  *chartInstance)
{
  ...
  c14_ys = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c14_xs = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c14_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c14_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c14_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c14_yaw = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c14_roll = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c14_pitch = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, chartInstance->c14_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c14_pitch, 0U);
  _SFD_DATA_RANGE_CHECK(*c14_roll, 1U);
  _SFD_DATA_RANGE_CHECK(*c14_yaw, 2U);
  _SFD_DATA_RANGE_CHECK(*c14_x, 3U);
  _SFD_DATA_RANGE_CHECK(*c14_y, 4U);
  _SFD_DATA_RANGE_CHECK(*c14_z, 5U);
  _SFD_DATA_RANGE_CHECK(*c14_xs, 6U);
  _SFD_DATA_RANGE_CHECK(*c14_ys, 7U);
  _SFD_DATA_RANGE_CHECK(*c14_zs, 8U);
  chartInstance->c14_sfEvent = CALL_EVENT;
  ...
  (SFc14_lab2_next_levelInstanceStruct *chartInstance)
{
  ...
  c14_b_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c14_e_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c14_b_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c14_b_yaw = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c14_b_roll = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c14_b_pitch = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, chartInstance->c14_sfEvent);
  c14_hoistedGlobal = *c14_b_pitch;
  c14_b_hoistedGlobal = *c14_b_roll;
  c14_c_hoistedGlobal = *c14_b_yaw;
  c14_d_hoistedGlobal = *c14_b_x;
  c14_e_hoistedGlobal = *c14_e_y;
  c14_f_hoistedGlobal = *c14_b_z;
  c14_pitch = c14_hoistedGlobal;
  c14_roll = c14_b_hoistedGlobal;
  c14_yaw = c14_c_hoistedGlobal;
  c14_x = c14_d_hoistedGlobal;
  c14_y = c14_e_hoistedGlobal;
  c14_z = c14_f_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 13U, 13U, c14_debug_family_names,
    c14_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c14_P, 0U, c14_c_sf_marshallOut,
    c14_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c14_M, 1U, c14_b_sf_marshallOut,
    c14_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_nargin, 2U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_nargout, 3U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_pitch, 4U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_roll, 5U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_yaw, 6U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_x, 7U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_y, 8U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_z, 9U, c14_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_xs, 10U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_ys, 11U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_zs, 12U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c14_i5 = 0; c14_i5 < 3; c14_i5++) {
    c14_C[c14_i5] = c14_M[c14_i5];
  }

  for (c14_i6 = 0; c14_i6 < 3; c14_i6++) {
    c14_M[c14_i6] = c14_C[c14_i6];
  }

  for (c14_i7 = 0; c14_i7 < 3; c14_i7++) {
    c14_C[c14_i7] = c14_M[c14_i7];
  }

  for (c14_i8 = 0; c14_i8 < 3; c14_i8++) {
    c14_M[c14_i8] = c14_C[c14_i8];
  }
  ...
  for (c14_i9 = 0; c14_i9 < 3; c14_i9++) {
    ...
    for (c14_i11 = 0; c14_i11 < 3; c14_i11++) {
      c14_M[c14_i9] += c14_a[c14_i10 + c14_i9] * c14_b[c14_i11];
      c14_i10 += 3;
    }
  }
  ...
  *c14_inData)
{
  ...
  for (c14_i12 = 0; c14_i12 < 3; c14_i12++) {
    c14_b_inData[c14_i12] = (*(real_T (*)[3])c14_inData)[c14_i12];
  }
  ...
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData)
{
  ...
  for (c14_i15 = 0; c14_i15 < 3; c14_i15++) {
    (*(real_T (*)[3])c14_outData)[c14_i15] = c14_y[c14_i15];
  }
  ...
  *c14_inData)
{
  ...
  for (c14_i17 = 0; c14_i17 < 3; c14_i17++) {
    for (c14_i18 = 0; c14_i18 < 3; c14_i18++) {
      c14_b_inData[c14_i18 + c14_i16] = (*(real_T (*)[9])c14_inData)[c14_i18 +
        c14_i16];
    }
  ...
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData)
{
  ...
  for (c14_i23 = 0; c14_i23 < 3; c14_i23++) {
    for (c14_i24 = 0; c14_i24 < 3; c14_i24++) {
      (*(real_T (*)[9])c14_outData)[c14_i24 + c14_i22] = c14_y[c14_i24 + c14_i22];
    }
...
const mxArray *sf_c14_lab2_next_level_get_eml_resolved_functions_info(void)
{
  ...
  for (c14_i25 = 0; c14_i25 < 9; c14_i25++) {
    c14_r0 = &c14_info[c14_i25];
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3574276388U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(159558197U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2011787410U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1976618861U);
}
...
mxArray *sf_c14_lab2_next_level_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("JrpKZ3RJMTqy9wNADHj7bG");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c14_roll = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c14_pitch = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c14_pitch);
          _SFD_SET_DATA_VALUE_PTR(1U, c14_roll);
          _SFD_SET_DATA_VALUE_PTR(2U, c14_yaw);
          _SFD_SET_DATA_VALUE_PTR(3U, c14_x);
          _SFD_SET_DATA_VALUE_PTR(4U, c14_y);
          _SFD_SET_DATA_VALUE_PTR(5U, c14_z);
          _SFD_SET_DATA_VALUE_PTR(6U, c14_xs);
          _SFD_SET_DATA_VALUE_PTR(7U, c14_ys);
          _SFD_SET_DATA_VALUE_PTR(8U, c14_zs);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c14_lab2_next_level(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3009729858U));
  ssSetChecksum1(S,(3887147445U));
  ssSetChecksum2(S,(2524152344U));
  ssSetChecksum3(S,(2999646308U));
