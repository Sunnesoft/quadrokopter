...
static const char * c15_debug_family_names[12] = { "s", "e", "M", "i", "k", "w",
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_c_emlrt_marshallIn(SFc15_lab2_next_levelInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_d_emlrt_marshallIn(SFc15_lab2_next_levelInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_lab2_next_level, const
  char_T *c15_identifier);
static uint8_T c15_e_emlrt_marshallIn(SFc15_lab2_next_levelInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
  ...
  (SFc15_lab2_next_levelInstanceStruct *chartInstance)
{
  ...
  c15_b_hoistedGlobal = chartInstance->c15_is_active_c15_lab2_next_level;
  ...
  (SFc15_lab2_next_levelInstanceStruct *chartInstance, const mxArray *c15_st)
{
  ...
  *c15_y = c15_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c15_u,
    0)), "y");
  chartInstance->c15_is_active_c15_lab2_next_level = c15_d_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T c15_hoistedGlobal;
  int32_T c15_i1;
  real_T c15_signal[10];
  real_T c15_wc;
  uint32_T c15_debug_family_var_map[12];
  real_T c15_s;
  real_T c15_e;
  real_T c15_M;
  real_T c15_i;
  ...
  real_T *c15_b_wc;
  real_T *c15_m_y;
  real_T (*c15_b_signal)[10];
  c15_b_wc = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c15_m_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c15_b_signal = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 10U, chartInstance->c15_sfEvent);
  for (c15_i0 = 0; c15_i0 < 10; c15_i0++) {
    _SFD_DATA_RANGE_CHECK((*c15_b_signal)[c15_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c15_m_y, 1U);
  _SFD_DATA_RANGE_CHECK(*c15_b_wc, 2U);
  chartInstance->c15_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 10U, chartInstance->c15_sfEvent);
  c15_hoistedGlobal = *c15_b_wc;
  for (c15_i1 = 0; c15_i1 < 10; c15_i1++) {
    c15_signal[c15_i1] = (*c15_b_signal)[c15_i1];
  }

  c15_wc = c15_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 12U, c15_debug_family_names,
    c15_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c15_s, 0U, c15_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_e, 1U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c15_M, 2U, c15_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_i, 3U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_k, 4U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_w, 5U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_h, 6U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_nargin, 7U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_nargout, 8U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c15_signal, 9U, c15_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c15_wc, 10U, c15_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_y, 11U, c15_sf_marshallOut,
    c15_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  while (c15_b_i < 10) {
    ...
    c15_b = c15_k;
    c15_b_y = 6.2831853071795862 * c15_b;
    c15_A = c15_b_y;
    c15_x = c15_A;
    c15_b_x = c15_x;
    c15_c_y = c15_b_x / 9.0;
    ...
    if (CV_EML_IF(0, 1, 0, c15_i != c15_s)) {
      _SFD_EML_CALL(0U, chartInstance->c15_sfEvent, 15);
      c15_b_A = c15_wc;
      c15_e_x = c15_b_A;
      c15_f_x = c15_e_x;
      c15_d_y = c15_f_x / 3.1415926535897931;
      c15_h = 1.0 - c15_d_y;
      _SFD_EML_CALL(0U, chartInstance->c15_sfEvent, 16);
      c15_a = c15_w;
      c15_c_b = c15_h;
      c15_e_y = c15_a * c15_c_b;
      c15_b_a = c15_e_y;
      c15_d_b = c15_signal[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("signal",
        (int32_T)_SFD_INTEGER_CHECK("s-k", c15_s - c15_k), 1, 10, 1, 0) - 1];
      c15_f_y = c15_b_a * c15_d_b;
      c15_y += c15_f_y;
      ...
      c15_c_a = c15_wc;
      c15_e_b = c15_k - c15_M;
      c15_g_y = c15_c_a * c15_e_b;
      c15_g_x = c15_g_y;
      c15_h_x = c15_g_x;
      c15_h_x = muDoubleScalarSin(c15_h_x);
      c15_f_b = c15_k - c15_M;
      c15_h_y = 3.1415926535897931 * c15_f_b;
      c15_c_A = -c15_h_x;
      c15_B = c15_h_y;
      c15_i_x = c15_c_A;
      c15_i_y = c15_B;
      c15_j_x = c15_i_x;
      c15_j_y = c15_i_y;
      c15_h = c15_j_x / c15_j_y;
      _SFD_EML_CALL(0U, chartInstance->c15_sfEvent, 21);
      c15_d_a = c15_w;
      c15_g_b = c15_h;
      c15_k_y = c15_d_a * c15_g_b;
      c15_e_a = c15_k_y;
      c15_h_b = c15_signal[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("signal",
        (int32_T)_SFD_INTEGER_CHECK("s-k", c15_s - c15_k), 1, 10, 1, 0) - 1];
      c15_l_y = c15_e_a * c15_h_b;
      c15_y += c15_l_y;
    }
  ...
  *c15_inData)
{
  ...
  chartInstance = (SFc15_lab2_next_levelInstanceStruct *)chartInstanceVoid;
  c15_mxArrayOutData = NULL;
  for (c15_i2 = 0; c15_i2 < 10; c15_i2++) {
    c15_b_inData[c15_i2] = (*(real_T (*)[10])c15_inData)[c15_i2];
  }

  for (c15_i3 = 0; c15_i3 < 10; c15_i3++) {
...
const mxArray *sf_c15_lab2_next_level_get_eml_resolved_functions_info(void)
{
  ...
  (*c15_b_info)[1].fileTimeLo = 1357944348U;
  (*c15_b_info)[1].fileTimeHi = 0U;
  (*c15_b_info)[1].mFileTimeLo = 1319722766U;
  ...
  (*c15_b_info)[7].fileTimeLo = 1343823186U;
  ...
  (*c15_b_info)[8].fileTimeLo = 1286811536U;
...
static const mxArray *sf_get_sim_state_info_c15_lab2_next_level(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c15_lab2_next_level\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c15_wc;
          real_T (*c15_signal)[10];
          c15_wc = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c15_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c15_signal = (real_T (*)[10])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c15_signal);
          _SFD_SET_DATA_VALUE_PTR(1U, c15_y);
          _SFD_SET_DATA_VALUE_PTR(2U, c15_wc);
        }
      }
    } else {
